...
When you run the command “ipconfig” in Windows PowerShell, you may see multiple IPv4 addresses—especially if you have: WiFi and Ethernet (wired) connections, VPNs (like OpenVPN, NordVPN), or Virtual network adapters (VMware, VirtualBox, WSL).
...
`sudo rsync -avz <WSL-username>@<WSL-ip>:"/mnt/c/Users/windows-nameofuser/.../filename" /ubuntu-server/path/to/destination`<br>
